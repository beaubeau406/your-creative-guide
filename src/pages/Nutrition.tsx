      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <p className="text-foreground text-2xl font-heading">{current.BMR || '-'}</p>
            <p className="text-muted-foreground text-xs">kcal</p>
          </div>
          <div>
            <p className="text-muted-foreground text-xs">BCJ</p>
            <p className="text-foreground text-2xl font-heading">{current.BCJ || '-'}</p>
            <p className="text-muted-foreground text-xs">kcal</p>
          </div>
          <div className="bg-muted rounded-xl p-3">
            <p className="text-muted-foreground text-xs">Objectif</p>
            <p className="text-energy text-3xl font-heading">{current['BCJ par Objectif'] || '-'}</p>
